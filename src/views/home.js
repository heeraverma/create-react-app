            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container24">
                ...
                <div className="home-container26">
                  ...
                  <span className="bodySmall">
                    Access to our full menu with unlimited customization options
                  </span>
                </div>
                ...
                <div className="home-container29">
                  ...
                  <span className="bodySmall">Free delivery on all orders</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  At Quick Bites Cafe, we offer a wide range of delectable fast
                  food options that are sure to satisfy your cravings. From
                  juicy burgers to crispy fries and refreshing beverages, our
                  menu has something for everyone. Each item is prepared with
                  fresh ingredients and served with a smile. Take a look at our
                  menu below and get ready to indulge in a flavorful experience.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
